race = {checkEquality => false} >> o -> (fun1,fun2,args,numIterations) -> (
    ...
    -- Concattenating with true false so that there's still an entry for both true and false
    -- bad solution for now, should just add the key to the hash table or do some case checking, but whateva
